  ...
  <div class="profile">
    <form @submit.prevent="submitForm" class="card-body">
      ...
      <div class="w-100 form-group">
        <label class="form-control-label"
          >لماذا ترغب بالإنضمام لعائلة حبايبنا (150) كلمة</label
        >
        <textarea
          rows="5"
          type="text"
      ...
      <div class="">
        <div class="d-flex">
          ...
          <!-- <button class="btn-3 radius-12" @click.prevent="showPasswordDialog">
            تغيير كلمة المرور
          </button> -->
        </div>
      </div>
    ...
    <PrivateModeDialog
      :show="PrivateModeDialog"
      @popup-alert="openAlertDialog"
      :private-mode="privateMode"
      @close-private-dialog="togglePrivateModeDialog"
    ></PrivateModeDialog>
...
export default {
  ...
  methods: {
    ...
    //   this.validateForm();
      ...
      this.$store.dispatch("admin/editParentData", {
