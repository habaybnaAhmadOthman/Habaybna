<template>
  <div class="log-col">
    ...
    <div class="recommendation">
      ...
      <p @click="addRecommendation" class="main-color bold pointer w-50-p" v-else-if="data.callStatus == 'succeded' && data.recommendation == ''">إضافة توصية</p>
      <p @click="showFullRecommendation" class="main-color bold pointer w-50-p" v-else-if="data.callStatus == 'succeded' && data.recommendation != ''">{{data.recommendation}}</p>
