...
export default {
    emits: ["close-private-dialog","popup-alert"],
    mixins: [loadingMixin],
    ...
    methods: {
        async submitForm() {
            ...
            try {
                ...
                this.$emit('popup-alert','privateModeDialog','تم حفظ التغييرات')
            } catch (e) {
                this.$emit('popup-alert','privateModeDialog','حصل خطأ ما')
            }
