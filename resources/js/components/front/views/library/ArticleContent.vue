  ...
  <div class="">
    <div class="box mt-30 flex-wrap-p p-side-12-p">
      <div class="content w-100-p">
        ...
        <router-link :to="`/specialist/${author.user_id}`" class="author-box bold mb-20 mt-10 d-flex align-center">
          <img :src="author.avatar | defaultAvatar" class="object-fit rounded" width="40" height="40">
          <div class="mr-10">
            <p class="font-14 main-color underline"> بواسطة : {{author.firstName + ' ' + author.lastName}} </p>
            <p class="font-14 gray">{{author.specialization}}</p>
          </div>
        </router-link>
        <div
