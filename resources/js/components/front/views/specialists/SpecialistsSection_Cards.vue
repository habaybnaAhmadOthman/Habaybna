        ...
        <div class="container">
            <div class="specialists-container">
                <template  v-if="data.length">
                    ...
                    <div class="  w-50 d-flex justify-center m-side-auto  more w-100-p mt-50" v-if="showMoreCard">
                        <router-link to="/all-specialists" class="btn-main font-20">إستعراض المزيد من الأخصائيين</router-link>
                    </div>
