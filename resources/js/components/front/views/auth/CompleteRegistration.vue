<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="row d-flex space-between">
            <!-- password -->
            <div
                class="form-group row-half relative pass-group"
        ...
        <!-- relative -->
        <div class="form-group mb-15" :class="{ invalid: !relative.isValid }">
            <div class="select-wrapper relative">
                <select
                    class="bg-white border-0 radius-5 w-100 p-10 pointer form-control trans"
        ...
        <button class="btn w-100 mt-30 bold font-20">
            حفظ
        </button>
        <div v-if="isLoading">
...
export default {
    ...
    methods: {
        validateForm() {
            ...
            if (
                this.rePassword.val == "" ||
                this.rePassword.val != this.password.val
            ) {
    ...
    components: { AuthHeader, LoadingSpinner }
};
</script>
